...
<footer>
		...
		<div id="footer-top">
			...
			<div class="company-info">
				<figure class="logo small">
					<img src="{{ asset('frontend/images/logo_small.png') }}" alt="logo-small">
				</figure>
				...
				<ul class="social-links">
					@if(setting('social.facebook'))<li class="social-link fb"><a href="{{ setting('social.facebook') }}"></a></li>@endif
				
					@if(setting('social.twitter'))<li class="social-link twt"><a href="{{ setting('social.twitter') }}"></a></li>@endif
						
					@if(setting('social.dribble'))<li class="social-link db"><a href="{{ setting('social.dribble') }}"></a></li>@endif
	...
	<div id="footer-bottom-wrap">
		<div id="footer-bottom">
			<p><span>&copy;</span><a href="index.html">{{ setting('site.title') }}</a> @lang('layout.copyrights') {{ date('Y') }}</p>
		</div>
	</div>
	<!-- /FOOTER BOTTOM -->
</footer>
