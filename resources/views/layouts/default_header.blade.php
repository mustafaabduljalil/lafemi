...
<div class="header-wrap">
	<header>
		...
		<div class="mobile-menu-handler left primary">
			<img src="{{ asset('frontend/images/pull-icon.png') }}" alt="pull-icon">
		</div>
		<!-- /MOBILE MENU HANDLER -->
		...
		<a href="index.html">
			<figure class="logo-mobile">
				<img src="{{ asset('frontend/images/logo_mobile.png') }}" alt="logo-mobile">
			</figure>
		</a>
		<!-- /LOGO MOBILE -->
		...
		<div class="user-board">
			@auth
						...
						<ul class="dropdown cart closed">
							...
							<li class="dropdown-item">
								...
								<figure class="product-preview-image tiny">
									<img src="{{ asset('frontend/images/items/pixel_s.jpg') }}" alt="">
								</figure>
							...
							<li class="dropdown-item">
								...
								<!-- /SVG PLUS -->
								<figure class="product-preview-image tiny">
									<img src="{{ asset('frontend/images/items/monsters_s.jpg') }}" alt="">
								</figure>
							...
							<li class="dropdown-item">
								...
								<!-- /SVG PLUS -->
								<figure class="product-preview-image tiny">
									<img src="{{ asset('frontend/images/items/flat_s.jpg') }}" alt="">
								</figure>
					...
					<div class="account-email-quickview">
						...
						<ul class="dropdown notifications closed">
							...
							<li class="dropdown-item">
								...
								<figure class="user-avatar">
									<img src="{{ asset('frontend/images/avatars/avatar_06.jpg') }}" alt="">
								</figure>
							...
							<li class="dropdown-item">
								<a href="dashboard-openmessage.html" class="link-to"></a>
								<figure class="user-avatar">
									<img src="{{ asset('frontend/images/avatars/avatar_04.jpg') }}" alt="">
								</figure>
							...
							<li class="dropdown-item">
								<a href="dashboard-openmessage.html" class="link-to"></a>
								<figure class="user-avatar">
									<img src="{{ asset('frontend/images/avatars/avatar_07.jpg') }}" alt="">
								</figure>
							...
							<li class="dropdown-item">
								<a href="dashboard-openmessage.html" class="link-to"></a>
								<figure class="user-avatar">
									<img src="{{ asset('frontend/images/avatars/avatar_08.jpg') }}" alt="">
								</figure>
					...
					<div class="account-settings-quickview">
						...
						<ul class="dropdown notifications no-hover closed">
							...
							<li class="dropdown-item">
								...
								<a href="author-profile.html">
									<figure class="user-avatar">
										<img src="{{ asset('frontend/images/avatars/avatar_02.jpg') }}" alt="">
									</figure>
								</a>
								<p class="title">
							...
							<li class="dropdown-item">
								<a href="author-profile.html">
									<figure class="user-avatar">
										<img src="{{ asset('frontend/images/avatars/avatar_03.jpg') }}" alt="">
									</figure>
								</a>
								<p class="title">
							...
							<li class="dropdown-item">
								<a href="author-profile.html">
									<figure class="user-avatar">
										<img src="{{ asset('frontend/images/avatars/avatar_05.jpg') }}" alt="">
									</figure>
								</a>
								<p class="title">
				...
				<div class="account-actions">
					...
					<a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="button secondary">{{ __('Logout') }}</a>
			...
			@guest
				<!-- GUEST ACTIONS -->
				<div class="account-actions">
					<a href="{{ route('register') }}" class="button primary">{{ __('Register') }}</a>
					<a href="{{ route('login') }}" class="button secondary">{{ __('Login') }}</a>
				</div>
				<!-- /GUEST ACTIONS -->
			@endguest
		</div>
...
<div class="main-menu-wrap">
	<div class="menu-bar">
		...
		<form class="search-form">
			...
			<input type="image" src="{{ asset('frontend/images/search-icon.png') }}" alt="search-icon">
		</form>
	</div>
</div>
<!-- /MAIN MENU -->