...
@section('content')
	...
	<div class="section-headline-wrap v3">
		<div class="section-headline">
			...
			<p>Home<span class="separator">/</span>Create Profile</p>
		</div>
	</div>
	<!-- /SECTION HEADLINE -->
	...
	<div class="section-wrap">
		<div class="section">
			<form id="create_profile_form" method="post" action="{{ route('save_provider_profile_creation') }}" role="form" novalidate enctype="multipart/form-data">
				@csrf
					...
					<div class="section-wrap">
						...
						<div class="form-popup" style="width:100%;">
							...
							<div class="form-popup-content">
								<h4 class="popup-title">Create new profile</h4>
								<!-- LINE SEPARATOR -->
								<hr class="line-separator">
								<!-- /LINE SEPARATOR --> 
								...
								<div class="form-group">
				                    ...
				                    <input data-parsley-required-message="Please enter business name" data-parsley-required="true" type="text" id="business_name" name="business_name" placeholder="Enter your business name here...">
			                    ...
			                    <div class="form-group">
									...
									<input data-parsley-required-message="Please enter business short description" data-parsley-required="true" row="4" cols="6" type="text" id="short_description" name="short_description" placeholder="Enter short description about your business hours here..."></textarea>
								...
								<div class="form-group">
				                    ...
				                    <input data-parsley-required-message="Please enter business hours" data-parsley-required="true" type="text" id="business_hours" name="business_hours" placeholder="Enter your business hours here...">
			                    ...
			                    <div class="form-group">
				                    ...
				                    <input data-parsley-required-message="Please enter city name" data-parsley-required="true" type="text" id="city" name="city" placeholder="Enter your city name here...">
			                    ...
			                    <div class="form-group">
									<label for="profile" class="rl-label required">Profile Image</label>
								...
								<div class="form-group">
									<button type="submit" class="button mid dark">Create <span class="primary">Profile</span></button>
								</div>
							</div>
							<!-- /FORM POPUP CONTENT -->
						</div>
...
@section('scripts')
	...
	<script type="text/javascript">
		$('#create_profile_form').parsley().destroy();
		$('#create_profile_form').parsley();
	</script>
@endsection